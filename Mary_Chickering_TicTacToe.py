...
def main():
    ...
    """
    while True:
        play_game = input("Do you want to play Tic Tac Toe? (yes or no)") #Asks user if they want to play
    ...
    while True:
        ...
        if player_amount.lower() != "one" and player_amount.lower() != "two": #IF player does not equal one or two
